    ...
    <div class="row">
        <div class="col-md-1">
            ...
            <div class="btn-group btn-group-vertical" style="width: 100px;">
                ...
                <button id="playerStay" class="btn btn-default" type="button"> Stay</button>
            </div>
                ...
                <tr>
                    <td style="height: 200px;">
                        ...
                        <div class="text-center">
                            <p id="playerScore"><font size="6" color="white"><strong>20</strong></font></p>
                        </div>
                        <p><font size="2">Host</font></p>
                        <div class="text-center">
                            <p id="hostScore"><font size="6" color="white"><strong>16</strong></font></p>
                        </div>
    ...
    <div class="row">
        <div class="col-md-1">
            ...
            <div class="btn-group btn-group-vertical" style="width: 100px;">
                ...
                <button id="hostStay" class="btn btn-default" type="button"> Stay</button>
            </div>
